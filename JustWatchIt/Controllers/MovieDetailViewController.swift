...
class MovieDetailViewController: UIViewController {
    ...
    @objc func addRecord(_ sender: UIButton){
        ...
        // 3
        guard let kongImage = UIImage(named: "kongPoster.jpg")?.jpeg else { return  }
        record.setValue("Kong", forKey: "title")
        record.setValue(2017, forKey: "year")
        record.setValue(kongImage, forKey: "posterImage")
